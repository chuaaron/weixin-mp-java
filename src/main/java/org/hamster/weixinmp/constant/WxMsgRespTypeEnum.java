...
public enum WxMsgRespTypeEnum {
	...
	NEWS(WxMsgRespType.NEWS), VIDEO(WxMsgRespType.VIDEO),SHORTVIDEO(WxMsgRespType.SHORTVIDEO), VOICE(WxMsgRespType.VOICE), INIT(WxMsgRespType.INIT), ENCRYPT(WxMsgRespType.ENCRYPT);;
	/**
	 * @param text
	 */
